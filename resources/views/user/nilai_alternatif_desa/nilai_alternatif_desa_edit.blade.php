        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <h1 class="h3 mb-3">{{ $title }} #{{ $nilai_alternatif_desa->kode_nilai_alternatif_desa }}</h1>
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <form
                                        action="{{ route('user.nilai-alternatif-desa.update', $nilai_alternatif_desa->kode_nilai_alternatif_desa) }}"
                                        method="post">
                                        @csrf
                                        @method('PUT')
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select form-select-lg" name="desa" id="desa">
                                                ...
                                                @foreach ($desa as $d)
                                                    <option value="{{ $d->kode_alternatif_desa }}"
                                                        {{ $nilai_alternatif_desa->kode_alternatif_desa == $d->kode_alternatif_desa ? 'selected' : '' }}>
                                                        {{ $d->nama_desa }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select form-select-lg" name="c1" id="c1">
                                                ...
                                                @foreach ($ketinggian_tempat as $k)
                                                    <option value="{{ $k->nilai }}"
                                                        {{ $nilai_alternatif_desa->nilai_c1 == $k->nilai ? 'selected' : '' }}>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select form-select-lg" name="c2" id="c2">
                                                ...
                                                @foreach ($curah_hujan as $c)
                                                    <option value="{{ $c->nilai }}"
                                                        {{ $nilai_alternatif_desa->nilai_c2 == $c->nilai ? 'selected' : '' }}>
                                            ...
                                            <select class="form-select form-select-lg" name="c3" id="c3">
                                                ...
                                                @foreach ($suhu as $s)
                                                    <option value="{{ $s->nilai }}"
                                                        {{ $nilai_alternatif_desa->nilai_c3 == $s->nilai ? 'selected' : '' }}>
                                            ...
                                            <select class="form-select form-select-lg" name="c4" id="c4">
                                                ...
                                                @foreach ($ph_tanah as $p)
                                                    <option value="{{ $p->nilai }}"
                                                        {{ $nilai_alternatif_desa->nilai_c4 == $p->nilai ? 'selected' : '' }}>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select form-select-lg" name="c5" id="c5">
                                                ...
                                                @foreach ($tekstur_tanah as $t)
                                                    <option value="{{ $t->nilai }}"
                                                        {{ $nilai_alternatif_desa->nilai_c5 == $t->nilai ? 'selected' : '' }}>
