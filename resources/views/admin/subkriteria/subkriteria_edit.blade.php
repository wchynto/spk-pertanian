        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <h1 class="h3 mb-3">{{ $title }} #{{ $subkriteria->kode_subkriteria }}</h1>
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{ route('admin.subkriteria.update', $subkriteria->kode_subkriteria) }}"
                                        method="post">
                                        @csrf
                                        @method('PUT')
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select form-select-lg" name="kriteria" id="kriteria">
                                                ...
                                                @foreach ($kriteria as $k)
                                                    <option value="{{ $k->kode_kriteria }}"
                                                        {{ $subkriteria->kode_kriteria == $k->kode_kriteria ? 'selected' : '' }}>
                                                        {{ $k->nama_kriteria }}
                                                    </option>
                                                @endforeach
                                            </select>
